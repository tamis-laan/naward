...
public class LanguageDetecter 
{
	...
	private HashMap<String,String>loadDomainMap()
	{
		...
		map.put(".vg" , "United Kingdom");
		map.put(".vi" , "United States");
		map.put(".vn" , "Vietnam");
		map.put(".vu" , "Vanuatu");
