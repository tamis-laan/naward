...
import norvigaward.naward14.bitcoinutils.BitcoinAddressValidator;
 ...
 */
class AddressExtracter extends Mapper<LongWritable, WarcRecord, Text, IntWritable> {
						...
						if (warcContent == null && "".equals(warcContent)) {
							...
							for (Element link : links) {
								...
								if (BitcoinAddressValidator.validateAddress(link.text())) {
									context.write(new Text(link.text()), new IntWritable(1));
								}
							}
